trigger CampaignTrigger on Campaign (after undelete, before delete,before insert,before update) {
...
if(LX_CommonUtilities.ByPassBusinessRule()) return; // [AS 07-Aug-13] : Added Bypass code
    ...
    {
        //Update Notification dates based on actual start date.
        LX_CampaignTriggerUtils.updateNotificationDates(trigger.New);
